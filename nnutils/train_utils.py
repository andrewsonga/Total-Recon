...
class v2s_trainer():
    ...
    def train(self):
        ...
        if opts.warmup_rootmlp:
            ...
            if opts.recon_bkgd or opts.use_bkgdrtk_for_fg:      # added on 12/17/22 to make the camera poses consistent with gt depth scaling when we initialize fg camera poses with bkgd extrinsics
