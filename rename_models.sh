...
for i in "${!current_config_names[@]}"; do
    ...
    echo renaming $current_config_name_leftcam to $desired_config_name_leftcam
    mv $logdir_dir/$current_config_name_leftcam $logdir_dir/$desired_config_name_leftcam
done