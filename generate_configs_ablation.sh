# e.g. prefix=cat2-stereo000
prefix=$1

# 1a) no depth: fg pretraining
cp configs/$prefix-leftcam.config configs/$prefix-nodepth-leftcam.config
...
cp configs/$prefix-leftcam.config configs/$prefix-nodeform-leftcam.config
...
cp configs/$prefix-leftcam.config configs/$prefix-noposenet-leftcam.config
...
cp configs/$prefix-leftcam.config configs/$prefix-norootbody-leftcam.config
...
cp configs/$prefix-leftcam.config configs/$prefix-se3-leftcam.config
...
cp configs/$prefix-leftcam.config configs/$prefix-norootbody-se3-leftcam.config
