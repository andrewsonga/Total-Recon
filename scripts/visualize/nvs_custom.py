...
flags.DEFINE_string('sildir', 'tmp/traj/','silhouette directory')
...
def main(_):
    ...
    rndsils = load_sils(opts.sildir.replace('ctrajs', 'refsil'),0)
    ...
    for i in range(bs):
        ...
        # looks like BANMo only renders pixels where the mask predicts a person        
