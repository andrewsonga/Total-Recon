...
# to account for fact that scikit-image's "skimage.measure.compare_ssim" method was renamed to "skimage.metrics.structural_similarity"
...
def dssim(p0, p1, range=255.):
    #####################################################################
    ################### modified by Chonghyuk Song ######################            
    # to account for fact that the "multichannel" param is going to be deprecated soon
