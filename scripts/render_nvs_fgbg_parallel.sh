...
startframe=0
#maxframe=100            # setting this value to -1 means that we intend to use all frames of raw video (a positive integer value indicates we will either upsample or downsample the number frames)
...
#screen -dmS "t2" bash -c "$cmd4; $cmd5; $cmd6"
...
#screen -dmS "t3" bash -c "$cmd4; $cmd5; $cmd6"
...
screen -dmS "t4" bash -c "$cmd1; $cmd2; $cmd3"
