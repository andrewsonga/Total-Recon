...
# --norecon_bkgd crops the gt observations around the detected foreground actor
# --recon_bkgd uses the full-scale gt observations, capturing both the foreground actor and ambient background