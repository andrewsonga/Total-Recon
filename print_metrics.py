...
if __name__ == "__main__":
    ...
    print("avg lpips: {}".format(np.round(avg_lpips_entire, 3)))
    print("avg psnr: {}".format(np.round(avg_psnr_entire, 2)))
    print("avg ssim: {}".format(np.round(avg_ssim_entire, 3)))
    print("rms depth error: {}".format(np.round(rms_depth_error_entire, 4)))
    print("avg depth acc at 10cm: {}".format(np.round(rms_depth_acc_at_10cm_entire, 4)))
    print("\n")